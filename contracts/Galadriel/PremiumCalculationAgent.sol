...
contract PremiumCalculationAgent {
    ...
    constructor(
        ...
        prompt = "Based on the provided weather data, time period, and location, perform a comprehensive risk assessment. Provide a detailed analysis of the risk level, calculate the premium amount, and determine the insurance coverage amount in dollars. Use relevant historical data, forecast predictions, and geographical considerations to ensure an accurate and fair assessment.";

...
const steps = [
  {
    id: "01",
    name: "Enter Details",
    description: "Enter Your Policy Details",
    href: "#",
  },
  {
    id: "02",
    name: "Get AI Enhanced Premium Prices",
    description: "Premium for your policy from our AI agent.",
    href: "#",
  },
  {
    id: "03",
    name: "Preview & Create Policy",
    description: "Preview and create your policy.",
    href: "#",
  },
];
              ...
              >
                {step.status === "complete" ? (
                  ...
                  <a href={step.href} aria-current="step">
                    <span
                      className="absolute left-0 top-0 h-full w-1 bg-white lg:bottom-0 lg:top-auto lg:h-1 lg:w-full"
                      aria-hidden="true"
                    />
                    <span
                      className={classNames(
